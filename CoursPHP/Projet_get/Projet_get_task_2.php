		...
		<!-- GIT commands
			...
			git commit -m "add Projet_get task 2"
		...
		<!-- Projet_get_task_1 Projet's : The answer to each question shows the following answer (without addressing the answer). CGE -->
		<!-- Projet_get_task_2 Projet's : Keep track of previous answers when switching from one question to another. CGE -->
		<?php
